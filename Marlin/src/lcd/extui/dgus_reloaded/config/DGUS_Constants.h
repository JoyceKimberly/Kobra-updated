...
#include "DGUS_Addr.h"
  ...
  #define DGUS_PRINT_BABYSTEP BABYSTEP_MULTIPLICATOR_Z
#endif

#ifndef DGUS_PLA_TEMP_HOTEND
  #define DGUS_PLA_TEMP_HOTEND PREHEAT_1_TEMP_HOTEND
#endif

#ifndef DGUS_PLA_TEMP_BED
  #define DGUS_PLA_TEMP_BED PREHEAT_1_TEMP_BED
#endif

#ifndef DGUS_ABS_TEMP_HOTEND
  #define DGUS_ABS_TEMP_HOTEND PREHEAT_2_TEMP_HOTEND
#endif

#ifndef DGUS_ABS_TEMP_BED
  #define DGUS_ABS_TEMP_BED PREHEAT_2_TEMP_BED
#endif
